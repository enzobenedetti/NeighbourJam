...
public class TextArchitect
{
    ...
    public bool isBuiding => buildProcess != null;
    ...
    private IEnumerator Build_Typewriter()
    {
        ...
        {
            tmpro.maxVisibleCharacters += hurryUp ? charactersPerCycle * 50 : charactersPerCycle;
    ...
    private IEnumerator Build_Fade()
    {
        ...
        while (true)
        {
            float fadeSpeed = ((hurryUp ? charactersPerCycle * 50 : charactersPerCycle) * speed) * 4f;
